package io.igrant.mobileagent.qrcode.view;
...
import io.igrant.mobileagent.qrcode.utils.ScreenUtils;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    public QrCodeFinderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaskColor = resources.getColor(R.color.mask_color);
        mFrameColor = resources.getColor(R.color.white);
        mLaserColor = resources.getColor(R.color.primaryBlue);
